        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final phone = _vendorPhoneCtrl.text.trim().isEmpty ? 'N/A' : _vendorPhoneCtrl.text.trim();

              try {
                // BUG-004 FIX: use auth headers (POST /api/v1/vendors requires admin role)
                ...
                debugPrint('Add Vendor response: ${response.statusCode}');
              } catch (e) {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 2),
                                Text('Candidate ID: ${c['candidate_code'] ?? c['candidateCode'] ?? 'CAN-0001'} • Vendor: ${c['vendor_code'] ?? _vendorCode}', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF2563EB))),
